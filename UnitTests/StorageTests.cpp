...
public:
	...
	TEST_METHOD(Fixed_Assign_New)	// Refer to comments on Fixed_Construct above for clarification of terms.
	{
	...
	TEST_METHOD(Fixed_Assign_Pop)	// Refer to comments on Fixed_Construct above for clarification of terms.
	{
